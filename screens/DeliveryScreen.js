    ...
    <View className='bg-[#00ccbb] flex-1'>
      <SafeAreaView className='z-50'>
        ...
        <View className='bg-white mx-5 my-2 rounded-md p-6 z-50 shadow-md'>
          ...
          <Text className='mt-3 text-gray-500'>Your order at {restaurant.title} is being processed</Text>
        </View>
      </SafeAreaView>
      ...
      <SafeAreaView className='bg-white flex-row items-center space-x-5 h-28'>
        <Image source={{ uri: 'http://links.papareact.com/wru' }} className='h-12 w-12 bg-gray-300 p-4 rounded-full ml-5' />
